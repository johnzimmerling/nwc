...
var txtRefer = {
    ...
    contactOccupation: 'Contact Role',
    placeholderOccupation: 'Optional Description',
    phone: 'Contact Phone Number',
    placeholderPhone: 'Enter 10 digits. Numbers only, no symbols, i.e. ##########',
    ...
    inside: 'Inside',
    outside: 'Outside',
    youcall: 'You should contact them',
    theycall: 'They will contact you',
